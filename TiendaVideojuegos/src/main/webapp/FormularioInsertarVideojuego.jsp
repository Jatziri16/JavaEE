					...
					<div class="login-container  col-7 col-sm-6 col-md-5 col-xl-5 rounded-end shadow">
						...
						<div class="centrar">
							...
							<form action="InsertarVideojuego.do" method="GET">
								...
								<input class="form-control mb-2" type="text" placeholder="Título" name="titulo" id="titulo">
								...
								<button class="btn btn-primary w-100" onclick="validarForms()" type="button">Insertar</button>
							</form>
						</div>
					</div>
				</div>
